...
export async function GET(): Promise<NextResponse<ApiResponse<SavedRateCard[]>>> {
  try {
    ...
    const transformedCards: SavedRateCard[] = rateCards.map((card) => ({
      ...
      adjustments: card.adjustments as SavedRateCard["adjustments"],
      dealQuality: card.dealQuality as SavedRateCard["dealQuality"],
...
export async function POST(
  ...
  try {
    ...
    const transformedCard: SavedRateCard = {
      ...
      adjustments: rateCard.adjustments as SavedRateCard["adjustments"],
      dealQuality: rateCard.dealQuality as SavedRateCard["dealQuality"],
