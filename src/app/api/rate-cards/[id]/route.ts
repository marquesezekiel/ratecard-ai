...
export async function GET(
  ...
  try {
    ...
    const transformedCard: SavedRateCard = {
      ...
      adjustments: updatedCard.adjustments as unknown as SavedRateCard["adjustments"],
      dealQuality: updatedCard.dealQuality as unknown as SavedRateCard["dealQuality"],
