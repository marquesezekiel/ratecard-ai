...
import type { CreatorProfile, PricingResult, DealQualityResult, ParsedBrief } from "@/lib/types";
...
export function ShareActions({ profile, brief, dealQuality, pricing }: ShareActionsProps) {
  ...
  const downloadPDF = async () => {
    ...
    try {
      const response = await fetch("/api/generate-pdf", {
        ...
        body: JSON.stringify({ profile, brief, dealQuality, pricing }),
      });
